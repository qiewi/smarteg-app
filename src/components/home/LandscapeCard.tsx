...
export default function LandscapeCard({
  ...
  return (
    <Link href={href}>
      <Card className="hover:shadow-lg transition-all duration-300 group border-0 rounded-3xl bg-gradient-to-tl from-[#014B3E] to-[#678E79] text-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-lg text-white font-bold drop-shadow-sm">{value}</span>
                  <span className="text-xs text-white/90">{subtitle}</span>
                </div>
              </div>
            </div>
          </div>
